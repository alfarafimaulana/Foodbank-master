        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(un) || TextUtils.isEmpty(fn) || TextUtils.isEmpty(qt) || TextUtils.isEmpty(nm) || TextUtils.isEmpty(imageUri)) {
                    Toast.makeText(DonateActivity.this, "Fields must not be empty, wait for the upload to finish", Toast.LENGTH_SHORT).show();
                } else {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.mmu.foodbank.android.fileprovider",
                        photoFile);
